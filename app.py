...
gender_vectorizer = open("/cnvrg/models/gender_vectorizer.pkl","rb")
gender_cv = joblib.load(gender_vectorizer)

# load Model For Gender Prediction
gender_nv_model = open("/cnvrg/models/naivebayesgendermodel.pkl","rb")
...
def main():
	...
	if st.button("About"):
		...
		st.text("Gender Classifier")
		st.text("By Bravin Wasike")
